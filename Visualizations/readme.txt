...
***Before diving in, be sure Data_Prep.R is loaded and run in order to put all the necessary objects into your R environment*****
This way, you can run any of the other code files without worry. 
...
The wordclouds can be a little tricky. Be sure to read the documentation at the top carefully. There are also notes and indicators among the code as you scroll down that should provide some help and point

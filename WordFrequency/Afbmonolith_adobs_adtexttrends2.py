...
stop_words = stopwords.words('english') + ["us", "help", "people", "need", "get", "span", "time", "like",
               ...
               "christmas", "last", "future", "together", "great", "many", "double", "season", "without", "live", "family",
               "online", "continue", "og", "find", "government", "stay", "information", "la", "life", "going", "thanks", 
               "doubled", "around", "part", "million", "love", "donations", "available", "good", "action", "hope", "well",
               "stop", "made", "december", "p", "protect", "community", "could", "watch", "social", "week", "business",
               "american", "may", "working", "energy", "families", "times", "canada", "state", "best", "january", "workers", "ar", "thank",
               "month", "communities", "deadline", "na", "show", "er", "even", "win", "voice" ]
...
consolidated_output.coalesce(1).write.csv("/home/madkins/example/Afbm_adobs_adtexttrends2.csv", header=True)
'''
